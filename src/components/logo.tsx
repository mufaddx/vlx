...
export function Logo({ className = "", prefetch = true }: { className?: string; prefetch?: boolean }) {
  return (
    <Link href="/" prefetch={prefetch} className={`group inline-flex items-center gap-2 ${className}`}>
